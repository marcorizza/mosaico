...
For each data stream, you define how it maps to a Mosaico ontology type. If you cannot reuse an existing SDK ontology, you can define your own custom class. We highly recommend reviewing the **[Ontology Customization Guide](../../examples/ontology_customization.md)** to see exactly how to write and register your own custom data models.
