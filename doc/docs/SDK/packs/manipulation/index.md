...
??? success "Topics Ingested into Mosaico"
    | Topic | Ontology Type |
    | :--- | :--- |
    | `capture_node-camera-image` | `CompressedImage` |
    | `events` | `EventCamera` |
    | `hama1` | `CompressedImage` |
    | `hama1_audio` | `AudioDataStamped` |
    | `hama2` | `CompressedImage` |
    | `hama2_audio` | `AudioDataStamped` |
    | `hand` | `CompressedImage` |
    | `hand_audio` | `AudioDataStamped` |
    | `robot_state/joint_state` | `RobotJoint` |
    | `robot_state/pose` | `Pose` |
    | `robot_state/velocity` | `Velocity` |
    | `robot_state/compensated_base_force_torque` | `ForceTorque` |
    | `robot_state/measured_force_torque` | `ForceTorque` |
...
??? success "Topics Ingested into Mosaico"
    | Topic | Ontology Type |
    | :--- | :--- |
    | `step/observation/image` | `CompressedImage` |
    | `step/observation/base_pose_tool_reached` | `Pose` |
    | `step/observation/orientation_start` | `Quaternion` |
    | `step/observation/src_rotation` | `Quaternion` |
    | `step/observation/natural_language_instruction` | `String` |
    | `step/observation/natural_language_embedding` | `TextEmbedding` |
    | `step/observation/gripper_closed` | `Floating32` |
    | `step/observation/gripper_closedness_commanded` | `Floating32` |
    | `step/observation/height_to_bottom` | `Floating32` |
    | `step/observation/rotation_delta_to_go` | `Vector3d` |
    | `step/observation/vector_to_go` | `Vector3d` |
    ...
    | `step/action/world_vector` | `Vector3d` |
    | `step/action/rotation_delta` | `Vector3d` |
    | `step/action/base_displacement_vector` | `Vector2d` |
    | `step/action/base_displacement_vertical_rotation` | `Floating32` |
    | `step/action/gripper_closedness_action` | `Floating32` |
    | `step/action/terminate_episode` | `TerminateEpisode` |
    | `step/reward` | `Floating32` |
    | `step/is_first` | `Boolean` |
    | `step/is_last` | `Boolean` |
    | `step/is_terminal` | `Boolean` |
...
??? success "Topics Ingested into Mosaico"
    | Topic | Ontology Type |
    | :--- | :--- |
    | `/observation/images/wrist_left` | `CompressedImage` |
    | `/observation/images/exterior_1_left` | `CompressedImage` |
    | `/observation/images/exterior_2_left` | `CompressedImage` |
    | `/observation/state/joint_position` | `RobotJoint` |
    | `/observation/state/cartesian_position` | `Pose` |
    ...
    | `/camera_extrinsics/exterior_2_left` | `Pose` |
    | `/step/reward` | `Floating64` |
    | `/step/discount` | `Floating64` |
    | `/step/task_index` | `Integer64` |
    | `/step/frame_index` | `Integer64` |
    | `/step/is_first` | `Boolean` |
    | `/step/is_last` | `Boolean` |
    | `/step/is_terminal` | `Boolean` |
...
!!! info "Execution Backend: Rosbag"

??? success "Topics Ingested into Mosaico"
    | Topic | Ontology Type |
    | :--- | :--- |
    | `/allegro_hand_right/joint_states` | `RobotJoint` |
    | `/iiwa/joint_states` | `RobotJoint` |
    | `/iiwa/eePose` | `Pose` |
